    ...
    <div className="min-h-screen bg-[#f9fafb] p-4">
      <div className="max-w-7xl mx-auto py-8">
        ...
        {usersData?.users && (
          (() => {
            const now = new Date();
            // Check actual expiry - if planExpiry exists and is in the past, user is expired
            const isActuallyActive = (u: typeof usersData.users[0]) => {
              if (u.planStatus !== 'active') return false;
              if (!u.planExpiry) return true; // No expiry = always active
              return new Date(u.planExpiry) > now;
            };
            const isActuallyExpired = (u: typeof usersData.users[0]) => {
              if (u.planStatus === 'expired') return true;
              if (u.planExpiry && new Date(u.planExpiry) <= now) return true;
              return false;
            };
            
            const actualActiveUsers = usersData.users.filter(isActuallyActive);
            const actualExpiredUsers = usersData.users.filter(isActuallyExpired);
            const freeActiveUsers = usersData.users.filter(u => u.planType === 'free' && isActuallyActive(u));
            const enterpriseActiveUsers = usersData.users.filter(u => u.planType === 'enterprise' && isActuallyActive(u));
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
                <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-blue-700">{usersData.users.length}</p>
                ...
                <Card className="bg-gradient-to-br from-red-50 to-red-100 border-red-200">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-red-700">
                      {actualExpiredUsers.length}
                    </p>
                    <p className="text-xs text-red-600">Expired Users</p>
                  </CardContent>
                </Card>
                <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-purple-700">
                      {usersData.users.filter(u => u.planType === 'empire' && isActuallyActive(u)).length}
                    </p>
                    <p className="text-xs text-purple-600">Empire Active</p>
                  </CardContent>
                </Card>
                <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-orange-700">
                      {usersData.users.filter(u => u.planType === 'scale' && isActuallyActive(u)).length}
                    </p>
                    <p className="text-xs text-orange-600">Scale Active</p>
                  </CardContent>
                </Card>
                <Card className="bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-2xl font-bold text-gray-700">
                      {usersData.users.filter(u => u.planType === 'free' && isActuallyActive(u)).length}
                    </p>
